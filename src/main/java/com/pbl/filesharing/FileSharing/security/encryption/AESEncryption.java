...
public class AESEncryption {
    public static void main(String[] args) throws Exception {
        ...
        FileInputStream inFile = new FileInputStream("B:\\PROG\\PROJECTS\\FileSharing\\FileSharing\\src\\main\\resources\\stuff\\document.txt");

        // encrypted file
        FileOutputStream outFile = new FileOutputStream("B:\\PROG\\PROJECTS\\FileSharing\\FileSharing\\src\\main\\resources\\stuff\\encryptedfile.des");

        // password to encrypt the file
        String password = "filesharing";
